        ...
        <div id="cta" class="max-w-[960px] px-[3%] lg:px-0 min-[1675px]:me-[2%]">
          ...
          <div id="cta-body">
            <p class="text-xl/8 sm:text-3xl/11 mb-7">
              I'm Ben, I've worked as a Senior Full Stack developer for over 15 years creating responsive, high-performance web applications. I bring expertise in PHP,
            ...
            <div class="flex">
              <a href="https://github.com/benpaynedev?tab=repositories" class="block underline pr-2 mr-2 border-r-1 border-gray-500" target="_blank">
                GitHub
              </a>
              <a href="https://bold.pro/my/ben-payne-250924114209" class="block underline" target="_blank">Resume</a>
            </div>
          </div>
        </div>
